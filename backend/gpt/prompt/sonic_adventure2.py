...
ダメージを負ったバイオリザードが、エクリプスキャノンの砲口へとカオスコントロールでワープし、無理矢理アークを地球に落とそうとしている。本作のラストボスで宇宙空間での戦闘となり、ソニック、シャドウはスーパー化して立ち向かう。生命維持装置は既に壊されており、体にかかる大きな負担によって皮膚の一部が腫瘍の様に腫れ上がっており、そこに体当たりすることでのみダメージを与えられる。使用曲はCrush40作曲「Live & Learn」。
