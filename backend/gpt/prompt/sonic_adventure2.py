...
敵を倒すと100点加算される。無敵中に敵を倒すとスコアが2倍になる。
...
ナックルズ・ルージュの宝探しではヒントを見るごとに500点スコアが減少する。ヒントを見ないで宝を見つけると高得点になる。
宝探しで1分経過すると500点スコアが減少する。
レーダーに反応していない宝を見つけると500点スコアが減少する。レーダーに反応していない宝は後回しにしておくと高得点になる。
